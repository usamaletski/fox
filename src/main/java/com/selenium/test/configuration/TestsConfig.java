...
public class TestsConfig {
    ...
    @Property("firefox.bin.url")
    private String firefoxBinUrl = "";

    @Property("desktop.application.url")
    private String desktopAppUrl = "";

    @Property("mobile.application.url")
    private String mobileAppUrl = "";

    @Property("screenshots.location")
    ...
    /**
     * @return firefox.exe location path
     */
    public String getFirefoxBinUrl() {
        return firefoxBinUrl;
    }

    /**
     * @return url for desktop application
     */
    ...
    /**
     * @return url for mobile application
     */
    ...
    /**
     * @return screenshots location path
     */
